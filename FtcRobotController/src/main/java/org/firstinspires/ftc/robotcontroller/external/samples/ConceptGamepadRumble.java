 ...
 *      1) Do Not SPAM the rumble motors by issuing rapid fire org.firstinspires.ftc.teamcode.commands
 *      2) Multiple sources for rumble org.firstinspires.ftc.teamcode.commands must coordinate to avoid tromping on each other.
 *
 *   This can be achieved several possible ways:
 *   1) Only having one source for rumble actions
 *   2) Issuing rumble org.firstinspires.ftc.teamcode.commands on transitions, rather than states.
 *      e.g. The moment a touch sensor is pressed, rather than the entire time it is being pressed.
 *   3) Scheduling rumble org.firstinspires.ftc.teamcode.commands based on timed events. e.g. 10 seconds prior to endgame
