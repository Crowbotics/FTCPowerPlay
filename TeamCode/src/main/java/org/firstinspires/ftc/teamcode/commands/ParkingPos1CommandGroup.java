...
public class ParkingPos1CommandGroup extends SequentialCommandGroup {

    public ParkingPos1CommandGroup(DriveSubsystem subsystem, Telemetry t){
        addCommands(
                ...
                new MecanumDriveStrafeCommand(subsystem,
                        Constants.kAutoSpeed, Constants.kAutoLeftParkDistance, t)
        );
